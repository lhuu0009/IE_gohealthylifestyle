	...
	public function sections( $manager ) {
		...
		$manager->add_section(
			new blaze_Customize_Section_Pro(
				...
				'blaze-upsells',
				array(
					'title'    => esc_html__( 'For more features', 'lifestyle-blog-lite' ),
					'pro_text' => esc_html__( 'Go Pro', 'lifestyle-blog-lite' ),
					'pro_url'  => esc_url( 'https://blazethemes.com/theme/lifestyle-blog-pro/' ),
					'priority' => 1
				)
			)
		);
