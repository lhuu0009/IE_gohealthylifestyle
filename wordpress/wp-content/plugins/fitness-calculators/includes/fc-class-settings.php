								...
								<tr>
									...
									<td>
										<select id="fcw_metric_only" name="fcw[fcw_metric_only]">
										 <option <?php if($this->fc_get_option('fcw_metric_only') == 'yes') { echo _e('selected');}  ?> value="yes">Yes</option>
										 <option <?php if($this->fc_get_option('fcw_metric_only') == 'no') { echo _e('selected');}  ?> value="no">No</option>
										</select>
									</td>
								</tr>
								<tr>
